...
public class AuthFilter implements GlobalFilter, Ordered {
    // 排除过滤的 uri 地址
    private static final String[] whiteList = {"/auth/authorizations", "/auth/refreshtoken"};
    ...
    private Mono<Void> setUnauthorizedResponse(ServerWebExchange exchange, String msg) {
        ...
        byte[] response = null;
        try {
            response = JSON.toJSONString(Result.error(CodeMsgConstants.ARGS_ERROR, msg)).getBytes(Constants.UTF8);
