package edu.nciae.common.redis.aspect;

import edu.nciae.common.redis.annotation.RedisCache;
import edu.nciae.common.redis.annotation.RedisEvict;
...
public class RedisAspect {
    ...
    /**
     * 定义切入点，使用 @RedisCache 的方法
     */
    @Pointcut("@annotation(edu.nciae.common.redis.annotation.RedisCache)")
    public void redisCachePoint() {
    }

    @Pointcut("@annotation(edu.nciae.common.redis.annotation.RedisEvict)")
